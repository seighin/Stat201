...
\begin{frame}{Hypotheses, practice} 
\begin{exampleblock}{Practice}
Break into groups of 2 to 4.\\
\medskip
For each of the practice scenarios:
\begin{itemize}
\item Identify the population the claim or test is about.
\item Identify the population parameter to be tested.
\item State the null and alternative hypotheses.
\item Identify test as one-sided or two-sided.
\end{itemize}
\end{exampleblock}
\end{frame}
...
\begin{frame}{Hypothesis tests, practice} 
\begin{exampleblock}{Practice}
Break into groups of 2 to 4.\\
\medskip
For each of the practice scenarios, conduct the appropriate test:
\begin{itemize}
\item Report the test statistic
\item Report the p-value
\item Report the decision on the null hypothesis
\item State the conclusion in terms of the original research question
\end{itemize}
\end{exampleblock}
\end{frame}
