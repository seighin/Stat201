...
\medskip
\bt{$\bv{P(A)}$ = At least one selected student has red hair}\\
\bt{$\bv{P(\bar A)}$ = No selected student has red hair = All selected students have not-red hair}\\
...
\medskip
\bt{Let $\bv A$ be the event a randomly selected student has black hair and $\bv B$ be the event a randomly selected student has brown eyes,}\\
\medskip$\ds \bv{P(B \mid A) = \frac{68}{108} \approx 0.630} \qquad \bv{P(B) = \frac {220}{592} \approx 0.372}$\\
\medskip$\bv{P(B) \ne P(B \mid A)}$\bt{, so having brown eyes is not independent of having black hair.}
\vspace{.5in}

\item Repeat part (b), but assume the student has brown hair.\\
\medskip
\bt{Let $\bv A$ be the event a randomly selected student has brown hair and $\bv B$ be the event a randomly selected student has brown eyes,}\\
\medskip$\ds \bv{P(B \mid A) = \frac{119}{286} \approx 0.416} \qquad \bv{P(B) \approx 0.372}$\\
\medskip\bt{While $\bv{P(B)$ is not exectly equal to $P(B \mid A)}$, they are close. The difference could be a result of sampling variation. Having brown eyes might be independent of having brown hair.}
