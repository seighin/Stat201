...
\item Price of a companies stock at a particular moment
\end{itemize}
\end{exampleblock}
\end{frame}
...
\begin{block}{}
{\large The collection probabilities of all the possible values of a random variable is known as the \bt{probability distribution} of the random variable.}
\begin{itemize}
