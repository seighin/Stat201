...
\pause\item The jury considers whether the evidence, when judged against a particular standard (\bt{beyond a reasonable doubt}), is sufficient to abandon the presumption of innocence.
...
\large
\begin{itemize}
\item The presumption of innocence is comparable to the \bt{null hypothesis}. An hypothesis tests is entered assuming that there is nothing interesting about the population(s) being studied.
