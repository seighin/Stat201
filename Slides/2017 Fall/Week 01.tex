...
\date[Aug 21, 2017]{August 21, 2017
...
\begin{block}{}
\large
\bt{Randomization} is the process selecting samples and assigning treatment groups randomly. This is done to ensure that samples are representative os populations and that characteristics are evenly distributed among treatment groups.
\end{block}
