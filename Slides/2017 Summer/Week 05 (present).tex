...
\begin{itemize}
\item The height of the curve (the y-value) is always between 0 and 1.
...
\begin{frame}{Probabilities, example}
\begin{exampleblock}{Example}
Using the standard normal distribution, find the probability a value is between -0.2 and 1.9 standard deviations, $P(-0.2 < Z < 1.1)$\\
\smallskip
{\centering
