...
\medskip
\bt{Observational study, cross-sectional}\\
\bt{Stratified/cluster sampling, not a simple random sample}
\end{itemize}
...
\item[(c)] Identify the type of study and the sampling method used. For observational studies be sure to specify the type and for experimental studies assess whether good design guidelines were followed. Is the sample a simple random sample? \\
\medskip
\bt{Experimental, has replication, blinding and randomization}\\
\bt{Convenience sample, not a simple random sample}
\end{itemize}
...
\item[(c)] Identify the type of study and the sampling method used. For observational studies be sure to specify the type and for experimental studies assess whether good design guidelines were followed. Is the sample a simple random sample?\\
\medskip
\bt{Observational study, prospective}\\
\bt{Cluster sampling (assuming they choose the town at random), not a simple random sample}
\end{itemize}
