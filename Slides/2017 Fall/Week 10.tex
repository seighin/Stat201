...
\date[Oct 30, 2017]{October 30, 2017}
...
\medskip
Test whether the program was successful at a 0.05 level of significance.
\begin{enumerate}
...
\begin{exampleblock}{Example}
\large
A ($1-2\alpha$)\%, or 90\%, confidence interval for $p_1 - p_2$ is\\
\pause\medskip
{\centering $\ds CI_{0.90} = (-0.127, \, 0.0299)$ \par}
\medskip
